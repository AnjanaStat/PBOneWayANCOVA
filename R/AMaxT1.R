#' Finds test statistic value and critical value of asymptotic Max-T test for testing equality  of treatment effects against ordered alternatives in one-way ANCOVA model with single covariate
#'
